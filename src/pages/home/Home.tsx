    ...
    <div className='relative pt-14 lg:flex items-center isolate overflow-hidden bg-white min-h-screen'>
      ...
      <div className='mx-auto flex-col lg:flex-row flex lg:justify-center px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-20 2xl:pb-40 2xl:pt-40'>
        <div className='mx-auto flex flex-col justify-center max-w-4xl lg:max-w-xl 2xl:max-w-2xl 3xl:max-w-3xl lg:mx-0 lg:flex-shrink-0'>
          <h1
            data-cy='title'
            className='mt-10 animate-text-pop-up-top !leading-tight lg:mt-0 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl'
          >
          ...
          <p
            data-cy='description'
            className='mt-6 animate-focus-in text-lg leading-8 text-gray-600 lg:max-w-xl '
          >
            {t('hero_token_description')}
          </p>

          <div className='mt-10 animate-focus-in flex items-center gap-x-6'>
            <Link
              title={t('get_started')}
        ...
        <div className='mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32'>
          <div className='w-full flex-none'>
            <div className='-m-2 animate-slide-in-elliptic-top-fwd rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4'>
              <img
